...
describe("Home", () => {
  ...
  test("carga imagenes", () => {
    ...
    const parametro = "Star";
    const history = createMemoryHistory();
    history.push(`/movie/${parametro}`);

    const renderizado = render(
      <Provider store={store}>
        <MemoryRouter initialEntries={["/movie/Star"]}>
          <Routes>
    ...
    console.log(renderizado.container.innerHTML);

    //carga una imagen
    expect(screen.getByRole("img")).toBeDefined();
    //Carga el texto de la pelicula
    const parrafo = renderizado.container.querySelector("p");
